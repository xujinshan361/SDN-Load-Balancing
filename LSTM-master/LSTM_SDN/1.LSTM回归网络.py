...
# da = len(scaler.inverse_transform(dataset))
# print(da +"da")
# for i in range(da):
# 	print(int(scaler.inverse_transform(dataset)[i]),end=',')

# print("\n\n")
# plt.plot(trainPredictPlot)
# tra = len(trainPredictPlot)
# #print(tra +"tra")
# for i in range(tra):
# 	print(int(trainPredict[i-1]),end=',')
# #
# print('\n\n')
# plt.plot(testPredictPlot)
# tes = len(testPredictPlot)
# print(tes +"tes")
# for i in range(tes):
# 	print(testPredict[i],end=',')
# # plt.show()